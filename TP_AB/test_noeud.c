...
main() 
{
  ...
  noeud_fg = noeud_creer( 2 , individu_2 , NULL , NULL , /*individu_referencer_cb*/individu_copier_cb ) ; 
  noeud_fd = noeud_creer( 3 , individu_3 , NULL , NULL , /*individu_referencer_cb*/individu_copier_cb) ; 
  noeud    = noeud_creer( 1 , individu_1 , noeud_fg , noeud_fd , /*individu_referencer_cb*/individu_copier_cb ) ; 
 ...
 ( noeud_est_pere(noeud_fg , noeud ) ? printf("-->KO\n") : printf ("-->OK\n") )  ;
  ...
  if( ( noerr = noeud_detruire( &noeud , /*individu_effacer_cb*/individu_detruire_cb ) ) )
    { 
      printf("Sortie avec code erreur = %d\n" , noerr ) ;
      return(noerr) ; 
    }

  if( ( noerr = noeud_detruire( &noeud_fg , /*individu_effacer_cb*/individu_detruire_cb ) ) )
   { 
      printf("Sortie avec code erreur = %d\n" , noerr ) ;
      return(noerr) ; 
    }

  if( ( noerr = noeud_detruire( &noeud_fd , /*individu_effacer_cb*/individu_detruire_cb ) ) )
    { 
      printf("Sortie avec code erreur = %d\n" , noerr ) ;
      return(noerr) ; 
    }
