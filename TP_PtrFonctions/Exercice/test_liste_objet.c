...
main() 
{
  ...
  liste -> liste_elem_ecrire( liste , (objet_t *)indiv_1 , 0 ) ;
  liste -> liste_elem_ecrire( liste , (objet_t *)frac_1  , 1 ) ;
  liste -> liste_elem_ecrire( liste , (objet_t *)str_1   , 2 ) ;
  liste -> liste_elem_ecrire( liste , (objet_t *)indiv_2 , 3 ) ;
  liste -> liste_elem_ecrire( liste , (objet_t *)frac_2  , 4 ) ;
  liste -> liste_elem_ecrire( liste , (objet_t *)str_2   , 5 ) ;
  liste -> liste_elem_ecrire( liste , (objet_t *)str_3   , 7 ) ;

  printf( "Test affichage liste \n" ) ;
  liste -> liste_afficher( liste , ' ' ) ; 
  printf( "\n");
  ...
  if( ( noerr = liste -> liste_detruire( &liste) ) )
    { 
